...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "7902709403:AAHd_YWVe15-b4UaPNmM5JoArgeWix7SOm4") 
    BOT_SESSION = environ.get("BOT_SESSION", "forward-bot") 
    DATABASE_URI = environ.get("DATABASE", "mongodb+srv://ftm:ftm@cluster0.rsvtl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
