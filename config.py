...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "7933287413:AAHyyX0IdjOk-T3MLD0GvEuEui60ZSKTIfE") 
    BOT_SESSION = environ.get("BOT_SESSION", "forward-bot") 
    DATABASE_URI = environ.get("DATABASE", "mongodb+srv://ftm:ftm@cluster0.w4syc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
